...
- Data analysis: SQL, Databricks, Teradata, DAX, Python, SAS, PySpark, Excel/VBA, and Google Sheets 
- Automation: Python, Power Automate, Shell, Bash, Batch, PowerShell, and VBScript 
- Low-code solutions: PowerApps and SharePoint 
- Design: Figma 
- Collaborative platforms: Confluence, Obsidian, and Notion

Key deliveries: 
- Development of an internal app with strong adoption and operational impact 
- Automation of critical processes with significant time and manual effort reduction 
- Creation of executive dashboards to support strategic decision-making 
- Technical and professional mentoring of interns in data

Education: 
- Postgraduate in Data Engineering - Data Science Academy (ongoing) 
- Associate degree in Systems Analysis and Development - FATEC Ipiranga 
- Certifications: Scrum Foundation (SFPC) and COBIT 5 Foundation

I work with a focus on efficiency, results impact, and continuous learning. 
...
- Mentoria técnica e profissional de estagiários em dados
...
Atuo com foco em eficiência, impacto nos resultados e aprendizado contínuo.
